...
// Test TrackedObject type visualization
...
type TrackedObjectKinematics_Constants = {
  UNAVAILABLE: 0;
  SIGN_UNKOWN: 1;
  AVAILABLE: 2;
};
...
export type TrackedObjectKinematics = {
  pose_with_covariance: PoseWithCovariance;
  orientation_availability: TrackedObjectKinematics_Constants;
...
export const DetectedObjectKinematics_Constants = {
  UNAVAILABLE: 0,
  SIGN_UNKOWN: 1,
  AVAILABLE: 2,
};
...
export type DetectedObjectKinematics = {
  pose_with_covariance: PoseWithCovariance;
  twist_with_covariance: TwistWithCovariance;
  orientation_availabilities: number;
  has_position_covariance: boolean;
  has_twist: boolean;
  has_twist_covariance: boolean;
};

export const ObjectClassification_Constants = {
  UNKNOWN: 0,
  CAR: 1,
  TRUCK: 2,
  BUS: 3,
